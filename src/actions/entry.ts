    ...
    const messages = [
      {
        role: "system",
        content: `
          You are a helpful assistant that asks insightful and reflective 4-6 questions that are ${userPreference}, regarding a user's journal entries. 
          ...
          Input Type 3: Rating scale -1 to +1

          Return all information in the format of valid JSON. All JSON objects should have a question and relevant input type, in the format below:
